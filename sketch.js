...
function preload(){
bgImg = loadImage("assets/images.jpg")
bgImg2 = loadImage("assets/bgnimg.jpg")
...
function setup(){
  ...
  createCanvas(800,displayHeight-150)
//background image
...
bottomGround = createSprite(200,680,800,20);
...
function spawnObstaclesTop() 
{
  if(World.frameCount % 60 === 0) {
    obstacleTop = createSprite(800,100,40,50);
    //obstacleTop.debug = true;
//obstacleTop.addImage(obsTop1);

obstacleTop.scale = 0.12;
obstacleTop.velocityX = -(4+score/100);
...
{
      if(World.frameCount % 60 === 0) {
        obstacleBottom = createSprite(800,displayHeight-260,40,50);
